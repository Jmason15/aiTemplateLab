...
function initApp() {
    ...
    function renderPromptsList() {
        ...
        container.innerHTML = prompts.map(p => `
            <div class="prompt-item ${p.id === currentPromptId ? 'active' : ''}" data-id="${p.id}">
    ...
    function showView() {
        console.log('Showing view screen');
