...
window.preloadedPrompts = [
    ...
    },
    {
        ...
        "inputs": [
            ...
            {
                "name": "Priority",
                "description": "Should the improvement focus on performance, readability, or both?",
        ...
        "outputs": [
            ...
            },
            {
                ...
                "type": "string",
                "example": "A list of detected risks in the original code (or remaining risks in the improved version) with type, description, location, and a concrete suggestion that respects the project constraints."
            }
        ],
        "success": [
